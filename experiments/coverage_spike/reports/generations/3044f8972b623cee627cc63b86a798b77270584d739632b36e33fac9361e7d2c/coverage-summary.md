...
| storage.private_endpoint | managed | yes | yes | yes | arg:arg.storage_account.private_endpoints@query-sha256-synthetic-v1 (primary, required)<br>aprl:synthetic.aprl.storage.private_endpoint@synthetic-v1 (corroborating, optional) | - |
| storage.public_network | managed | yes | yes | yes | arm:arm.storage_account.resource@2023-05-01 (primary, required)<br>defender:synthetic.defender.storage.public_network@synthetic-v1 (corroborating, optional) | - |
| storage.redundancy | managed | yes | yes | yes | arm:arm.storage_account.resource@2023-05-01 (primary, required)<br>advisor:synthetic.advisor.storage.redundancy@synthetic-v1 (corroborating, optional) | - |
| storage.secure_transfer | managed | yes | yes | yes | arm:arm.storage_account.resource@2023-05-01 (primary, required)<br>azure_policy:synthetic.azure_policy.storage.secure_transfer@synthetic-v1 (corroborating, optional) | - |
